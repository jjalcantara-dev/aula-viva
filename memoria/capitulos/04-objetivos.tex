...
ejecutar los experimentos para evitar ajustarlas a los resultados obtenidos. La
tabla~\ref{tab:criterios} los recoge:
...
Queda fuera también la medición del efecto del sistema sobre el alumnado que está
aprendiendo el castellano. Ese colectivo se identifica en el capítulo~\ref{cap:estado} como
segunda población beneficiaria, con la evidencia que lo respalda, y condiciona una decisión
de diseño concreta: que la vista de recepción sea abierta. Pero ningún objetivo de este
trabajo se formula sobre él, porque comprobarlo exige evaluación con personas.
